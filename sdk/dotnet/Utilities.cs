...
namespace ABKLabs.Runner
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/abklabs";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("ABKLabs.Runner.version.txt");
    ...
    internal sealed class RunnerResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public RunnerResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
